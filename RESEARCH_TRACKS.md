...
| Runtime | Dispatch, memory traffic, fused/compiled kernels used by either track | **Engineering track** | `exp/track-runtime` | Implement a Triton-independent static-index/fused decode path; local Inductor is blocked |
