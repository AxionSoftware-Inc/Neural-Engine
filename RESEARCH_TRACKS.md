...
| Runtime | Dispatch, memory traffic, fused/compiled kernels used by either track | **Engineering track** | `exp/track-runtime` | Integrate per-worker native fused shape-cache ownership into a serving entry point; dynamic routing remains graph-unsafe |
