...
| Runtime | Dispatch, memory traffic, fused/compiled kernels used by either track | **Engineering track** | `exp/track-runtime` | Validate the native fused factorized path across serving shapes; dynamic routing remains graph-unsafe |
