...
|---|---|---|---|---|
| Native Engine | Original attention-free Neural Engine on synthetic algorithmic tasks | **Quality scaling open; retrieval and simple state-write fixes rejected** | `exp/track-native-engine` | Test reusable algebraic value/state representation at 20M; keep larger banks frozen |
