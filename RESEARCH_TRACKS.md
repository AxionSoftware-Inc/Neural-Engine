...
| Runtime | Dispatch, memory traffic, fused/compiled kernels used by either track | **Engineering track** | `exp/track-runtime` | Add deployment-specific multi-process launcher/admission stress tests; dynamic routing remains graph-unsafe |
