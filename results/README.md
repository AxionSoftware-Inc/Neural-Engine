...
- [P-003 — Route-fragmentation frontier recheck](P003_ROUTE_FRONTIER_RECHECK_20260910.md)
- [P-003 — Frozen route-capacity clamp audit](P003_ROUTE_CAPACITY_CLAMP_AUDIT_20260910.md)
...
- [V0.309–V0.311 — Algebraic dataflow follow-up audit](V0_309_311_ALGEBRAIC_DATAFLOW_AUDIT.md)
- [V0.312 — Typed-digit write follow-up](V0_309_311_ALGEBRAIC_DATAFLOW_AUDIT.md)
...
- [V0.324 — Lower targeted-coverage control](V0_309_311_ALGEBRAIC_DATAFLOW_AUDIT.md)
...
- [V0.337 — Serial dispatch BMM/prefetch A/B](V0_335_NATIVE_RUNTIME_500M_AUDIT.md)
- [V0.338 — Serial/parallel composition control](V0_335_NATIVE_RUNTIME_500M_AUDIT.md)
- [V0.339 — Parallel-continuation quality control](V0_335_NATIVE_RUNTIME_500M_AUDIT.md)
- [V0.340 — Dynamic torch.compile smoke](V0_335_NATIVE_RUNTIME_500M_AUDIT.md)
...
- [P-007 — Trained post-GRU residual audit](P007_POST_CORRECTION_RESIDUAL_TRAINING_AUDIT_20260908.md)
...
V0.233 completes the corrected above-range screen with
`value_encoder_modulus=128`, matched rank16/no-interaction arms, and the same
`0..63 → 64..95` protocol. Across four seeds, rank16 improves hard accuracy
by `+0.98 pp` overall and `+0.98 pp` depth-4 (`58.11%`/`50.39%` versus
`57.13%`/`49.41%`), while CE regresses by `+0.3885`. The hard gain is
consistent but small; rank16 remains opt-in and the default is unchanged.
...
V0.294 repeats the multiply-only diagnostic for a matched 5,000-step run.
Fixed multiply accuracy remains `3.906%/2.734%` at held-out depths 3/4, with
train depth-2 only `9.961%`; extra operation coverage does not improve V0.290's
`3.906%/4.199%`. **Rejected as the primary operation-coverage solution; no
...
instead of `1..2`, then evaluates unseen depth `4`. Across two seeds the
held-out mean is `2.979%` versus V0.298's `14.355%`; fixed depth-4
add/subtract/multiply are `9.570%/8.984%/6.055%` versus
