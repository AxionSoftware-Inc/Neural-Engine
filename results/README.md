...
- [P-003 — Native dynamic-width oracle audit](P003_NATIVE_DYNAMIC_WIDTH_ORACLE_AUDIT_20260910.md)
- [P-003 — Native dynamic-width oracle JSON](diagnostic_native_dynamic_width_oracle_20260910.json)
- [P-003 — Native learned dynamic-width audit](P003_NATIVE_LEARNED_WIDTH_AUDIT_20260910.md)
- [P-003 — Native learned-width OOD JSON](diagnostic_native_learned_width_20260910.json)
- [P-003 — Native learned-width training JSON](diagnostic_native_learned_width_training_20260910.json)
- [P-003 — Native dynamic-width runtime audit](P003_NATIVE_DYNAMIC_WIDTH_RUNTIME_AUDIT_20260910.md)
- [P-003 — Native dynamic-width runtime JSON](diagnostic_native_width_runtime_20260910.json)
- [P-003 — Native three-seed learned-width OOD JSON](diagnostic_native_learned_width_all3_20260910.json)
- [P-003 — Native scratch seed19 learned-width OOD JSON](diagnostic_native_learned_width_s19_20260910.json)
...
- [P-003 — Native CUDA Graph audit](P003_NATIVE_CUDA_GRAPH_AUDIT_20260910.md)
- [P-003 — Native fixed-K=16 CUDA Graph JSON](diagnostic_native_cuda_graph_fixed16_b1_20260910.json)
- [P-003 — Native learned CUDA Graph JSON](diagnostic_native_cuda_graph_learned_b1_20260910.json)
- [P-003 — Native learned dynamic CUDA Graph JSON](diagnostic_native_cuda_graph_learned_b32_20260910.json)
...
- [P-003 — Native fused shape-cache B=1 JSON](diagnostic_native_fused_shape_cache_s17_b1_20260910.json)
- [P-003 — Native fused shape-cache B=8 JSON](diagnostic_native_fused_shape_cache_s17_b8_20260910.json)
- [P-003 — Native fused same-stream concurrency JSON](diagnostic_native_fused_serving_concurrency_s17_b1_20260910.json)
...
- [P-003 — Native fused one-vs-two-worker scaling JSON](diagnostic_native_fused_worker_scaling_s17_20260910.json)
...
- [P-003 — Native fused mixed-shape microbatch JSON](diagnostic_native_fused_mixed_microbatch_s17_20260910.json)
- [P-003 — Native fused explicit batch endpoint JSON](diagnostic_native_fused_batch_endpoint_s17_20260910.json)
