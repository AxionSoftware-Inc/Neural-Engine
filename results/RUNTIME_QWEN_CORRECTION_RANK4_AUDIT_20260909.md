...
The quality gate is `CE delta < +0.05`; both independent seeds pass it.
...
| 4 | 2026, 17 | `+0.037330…+0.040037` | `1.339x/1.330x` | smallest tested viable opt-in |
...
near-dense runtime but unacceptable quality. Rank 4 still needs a longer
training-budget check and a third seed before any default change. The next
